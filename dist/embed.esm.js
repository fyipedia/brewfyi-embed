/* brewfyi-embed v1.1.1 | MIT | https://widget.brewfyi.com */
...
// src/cards/brew-card.ts
function renderBrewCard(container, data, config, _lang) {
  var _a, _b, _c, _d, _e, _f, _g, _h, _i;
  const name = String((_a = data.name) != null ? _a : "");
  const species = String((_b = data.species_name) != null ? _b : "");
  const origin = String((_c = data.origin_country_name) != null ? _c : "");
  const genetics = String((_d = data.genetic_group) != null ? _d : "");
  const quality = String((_e = data.quality_potential) != null ? _e : "");
  const altitude = String((_f = data.altitude_range) != null ? _f : "");
  const yieldPot = String((_g = data.yield_potential) != null ? _g : "");
  const desc = String((_h = data.description) != null ? _h : "");
  const url = String((_i = data.url) != null ? _i : `https://${config.domain}/${config.entitySlug}/`);
  const subtitle = [species, origin].filter(Boolean).join(" \xB7 ");
  const stats = [
    genetics ? { value: genetics, label: "Genetics" } : null,
    quality ? { value: quality, label: "Quality" } : null,
    altitude ? { value: altitude, label: "Altitude" } : null,
    yieldPot ? { value: yieldPot, label: "Yield" } : null
  ].filter((s) => s !== null);
  container.innerHTML = [
...
// src/_entry_brewfyi.ts
setSiteCardRenderer(renderBrewCard);
...
(function bootstrap() {
  const config = '{"site":"brewfyi","name":"BrewFYI","domain":"brewfyi.com","accent":"#78350F","attribute":"data-brewfyi","apiBase":"https://brewfyi.com/api/v1/","searchPath":"/search/","entityName":"Coffee Varieties","entitySlug":"varieties"}';
...
function makeWidgetElement(widgetType, initFn, domainAttrs) {
  ...
  return class extends HTMLElement {
    ...
    connectedCallback() {
      ...
      this._syncDataAttrs();
      initFn(this, '{"site":"brewfyi","name":"BrewFYI","domain":"brewfyi.com","accent":"#78350F","attribute":"data-brewfyi","apiBase":"https://brewfyi.com/api/v1/","searchPath":"/search/","entityName":"Coffee Varieties","entitySlug":"varieties"}');
    }
    ...
    _syncDataAttrs() {
      const attrKey = '{"site":"brewfyi","name":"BrewFYI","domain":"brewfyi.com","accent":"#78350F","attribute":"data-brewfyi","apiBase":"https://brewfyi.com/api/v1/","searchPath":"/search/","entityName":"Coffee Varieties","entitySlug":"varieties"}'.attribute.replace("data-", "");
...
(function registerElements() {
  ...
  const site = '{"site":"brewfyi","name":"BrewFYI","domain":"brewfyi.com","accent":"#78350F","attribute":"data-brewfyi","apiBase":"https://brewfyi.com/api/v1/","searchPath":"/search/","entityName":"Coffee Varieties","entitySlug":"varieties"}'.site;
  const defs = [
